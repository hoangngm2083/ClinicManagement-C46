...
public class EmailSenderImpl implements EmailSender {
    ...
    @Override
    @Retryable(retryFor = {EmailSendingException.class}, maxAttemptsExpression = "${retry.maxAttempts}", backoff = @Backoff(delayExpression = "${retry.maxDelay}"))
    ...
    @Recover
    public void recover(EmailSendingException e, String to, String subject, String html, EmailContentType type) {
